# Author: Sasta Dev || https://t.me/Haruki_Shiga_16
# Author's github: https://github.com/Haruki-Sama
...
class STRINGS:
    ...
    SUPPORT_CHAT = '<b>Support Chat:</b> @BotsXSupport'
    REVERSE_RESULT = '''
